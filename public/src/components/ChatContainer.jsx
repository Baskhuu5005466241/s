...
//     try {
//       await axios.delete(`/api/chats/${currentChat._id}`);
//       console.log(currentChat._id)
//       // Optionally, you can update your UI after deletion (e.g., redirect to a different page)
//       // Add your logic here
//     } catch (error) {
...
//     }
//   };
//   <button onClick={handleDeleteMsg}>Delete Chat</button>
...
//               <p>{message.message}</p>
//               {message.fromSelf && (
//                 <button onClick={() => handleDeleteMsg(message._id)}>Delete</button>
//               )}
//             </div>
//           </div>
//         ))}
